...
I combine what most ecosystem managers do not have: 10+ years of DevOps on Ubuntu-based Linux infrastructure and a track record of building the software ecosystems themselves. At Tonomy Foundation, I co-built an open-source identity protocol from zero: stakeholder mapping, W3C DID working group engagement, partner onboarding, and a whitepaper that anchored the ecosystem externally. That project earned W3C recognition. The method is the same as any ISV alliance motion: align on the technical vision, create the content that makes adoption possible, build the community that sustains it.
...
github.com/Value-Chain-Hackers
