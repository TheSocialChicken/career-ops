...
| career-story.md | `career-story.md` (if exists) | When generating cover letters, CV summaries, or STAR stories — richer voice and proof point context than profile.yml alone |
