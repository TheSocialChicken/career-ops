...
async function main() {
  ...
  for (const role of ROLES) {
    ...
    const html = template
      .replace('{{LANG}}', 'en')
      .replace('{{NAME}}', 'Christiaan Verhoef')
      .replace('{{PAGE_WIDTH}}', '210mm')
      .replace('{{PHONE}}', '+31 6 30 18 47 43')
      .replace('{{EMAIL}}', 'christiaan_gerardo@hotmail.com')
      .replace('{{LINKEDIN_URL}}', 'https://linkedin.com/in/christiaanverhoef')
      .replace('{{LINKEDIN_DISPLAY}}', 'linkedin.com/in/christiaanverhoef')
      .replace('{{PORTFOLIO_URL}}', role.portfolio_url)
      .replace('{{PORTFOLIO_DISPLAY}}', role.portfolio_display)
      .replace('{{LOCATION}}', 'Baarn, Netherlands')
      ...
      .replace('{{EXPERIENCE}}', BASE_EXPERIENCE)
      .replace('{{SECTION_PROJECTS}}', 'Selected Projects')
      .replace('{{PROJECTS}}', role.projects)
      .replace('{{SECTION_EDUCATION}}', 'Education')
      .replace('{{EDUCATION}}', BASE_EDUCATION)
      .replace('{{SECTION_CERTIFICATIONS}}', 'Certifications')
      .replace('{{CERTIFICATIONS}}', BASE_CERTIFICATIONS)
      .replace('{{SECTION_SKILLS}}', 'Skills')
      .replace('{{SKILLS}}', BASE_SKILLS);
